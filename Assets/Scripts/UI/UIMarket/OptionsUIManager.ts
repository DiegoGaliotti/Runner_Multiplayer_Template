...
export default class OptionsUIManager extends ZepetoScriptBehaviour {

    public mainMenuButton: Button; //Reference to the button to go back to main menu
    public static Instance: OptionsUIManager; // This class instance
    
        // Awake is called when the script instance is being loaded
    Awake() {
        // This is how the instance of this class is allocated. Which makes it a "singleton"
        // https://en.wikipedia.org/wiki/Singleton_pattern
        if (OptionsUIManager.Instance != null) GameObject.Destroy(this.gameObject);
        OptionsUIManager.Instance = this;
    }
